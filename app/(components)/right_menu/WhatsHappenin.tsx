...
export function WhatsHappenin() {
    return (
    <div className="flex justify-center w-[90%] rounded-xl mb-3">
            ...
            <div className="w-full bg-black justify-center rounded-xl">
                <div className="flex flex-col w-full justify-around">
                    <div>
                        <p className="font-extrabold text-[20px] text-wrap p-4">What's happenning?</p>
                    </div>
                    <div className="h-60">
